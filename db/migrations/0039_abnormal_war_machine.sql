...
INSERT INTO `__new_setup_pass`("id", "camp_id", "edition_id", "pass_date_id", "membership_id", "status", "note", "resolved_by_membership_id", "resolved_at", "created_by_id", "created_at") SELECT "id", "camp_id", "edition_id", "pass_date_id", "membership_id", "status", "note", "resolved_by_membership_id", "resolved_at", "created_by_id", "created_at" FROM `setup_pass`;--> statement-breakpoint
...
ALTER TABLE `participation` ADD `arrival_date` text;